...
def author():                                                                                             
        return "zliu723" # replace gburdell3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903476881 # replace with your GT ID number      
...
class PageRank:
    def __init__(self, edge_file):
        ...
        # print("self.edge_file = ", self.edge_file)
    ...
    # Zi's own note - another way to write this.The difference is using return it has to compute everything before return the value
    # def read_edge_file(self, edge_file):
    #     res_list = []
    #     with open(edge_file) as f:
    #         for line in f:
    #             val = line.split('\t')
    #             res_list.append((int(val[0]), int(val[1])))
    #     return res_list
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        ### Implement your code here
        #############################################
                new_pr_values[target] += damping_factor * np.array(pr_values[source] / self.node_degree[source])
