...
class Data():
    ...
    def dataAllocation(self,path):
        ...
        y_data = data.loc[:,data.columns == "y"]
    ...
    def trainSets(self,x_data,y_data):
        ...
        # -------------------------------
        random_state = 614
        x_train, x_test, y_train, y_test = train_test_split(x_data, y_data, train_size=0.7,test_size=0.3, random_state= random_state, shuffle = True)
...
#         print('y_predict_train:', y_predict_train[:10])
#         print('y_predict_test:', y_predict_test[:10])
        # -------------------------------
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        # return: float
        # -------------------------------
        y_predict_train_round = [np.round(i) for i in y_predict_train]
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        # return: float
        # -------------------------------
        y_predict_test_round = [np.round(i) for i in y_predict_test]
...
# Q3.4.2 Classification
    ...
    def SVCClassifier(self,scaled_x_train,scaled_x_test, y_train):
        ...
        # return: numpy array, numpy array
        # -------------------------------
        svc_model = SVC(gamma = 'auto').fit(scaled_x_train,y_train)
        y_predict_train = svc_model.predict(scaled_x_train)
        y_predict_test = svc_model.predict(scaled_x_test)
        # -------------------------------
        return y_predict_train,y_predict_test
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        svm_cv = GridSearchCV(svm_tune, svm_parameters, n_jobs = -1,return_train_score = True)
    ...
    def svcTestAccuracy(self,y_test,y_predict_test):
        ...
        # return: float
        # -------------------------------
        train_accuracy = accuracy_score(y_test,y_predict_test)
